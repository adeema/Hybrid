 ...
 */
package com.capgemini.crescent.test.setup;
...
import com.capgemini.crescent.test.constants.CrescentTestConstants;
import com.capgemini.crescent.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CrescentTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/crescenttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/crescenttest/import/reviews.impex");
			...
			importImpexFile(context, "/crescenttest/import/cstickets.impex");
		}
	}
}
