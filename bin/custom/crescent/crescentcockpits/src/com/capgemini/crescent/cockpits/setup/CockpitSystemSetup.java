 ...
 */
package com.capgemini.crescent.cockpits.setup;
...
import com.capgemini.crescent.cockpits.constants.CrescentCockpitsConstants;
 ...
 */
@SystemSetup(extension = CrescentCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(CrescentCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(CrescentCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						CrescentCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/crescentcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
