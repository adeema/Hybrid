 ...
 */
package com.capgemini.crescent.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("crescentcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("crescentcockpits.product.externalTaxes"));
