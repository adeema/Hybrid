 ...
 */
package com.capgemini.crescent.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, CrescentFulfilmentProcessConstants.PARENT_PROCESS);
