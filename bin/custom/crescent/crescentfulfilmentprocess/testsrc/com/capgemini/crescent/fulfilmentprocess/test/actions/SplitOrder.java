 ...
 */
package com.capgemini.crescent.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(CrescentFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CrescentFulfilmentProcessConstants.PARENT_PROCESS);
